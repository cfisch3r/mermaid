...
export type DiagramAST = Info | Packet | Pie | Architecture | GitGraph | Radar | ContextMap;
...
const initializers = {
  ...
  contextMap: async () => {
    const { createContextMapServices } = await import('./language/context-map/index.js');
